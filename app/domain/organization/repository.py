...
from app.domain.protocols.repositories import OrganizationRepositoryProtocol, OrganizationMemberRepositoryProtocol
...
class OrgMemberRepository(OrganizationMemberRepositoryProtocol):
